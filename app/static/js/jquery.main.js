...
function initRightSide() {
	...
	jQuery('.page-right-side').each(function() {
		var box = jQuery(this);
...
function initSlickCarousel() {
	jQuery('.box-slider').slick({
		...
		rows: 0,
		slidesToShow: 3,
		prevArrow: '<button class="slick-prev"><span class="icon icon-arrrow-l"></span></button>',
		nextArrow: '<button class="slick-next"><span class="icon icon-arrrow-r"></span></button>',
		dots: true,
